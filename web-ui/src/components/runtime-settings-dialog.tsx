...
import { TASK_GIT_BASE_REF_PROMPT_VARIABLE, type TaskGitAction } from "@runtime-task-git-action-prompt";
import {
	Bell,
	Bot,
	Check,
		...
		<Dialog open={open} onOpenChange={handleDialogOpenChange} contentClassName="!max-w-[780px]">
			...
			<DialogFooter>
				<Button
					...
					onClick={() => window.open("https://github.com/angel-manuel/kanban#readme", "_blank")}
				>
					Read the docs
				</Button>
